...
# fungsi filter tempat wisata dan hotel
...
def cetak_struk_holiyay(
        username, tempat_wisata, harga_tempat_wisata, hotel_pilihan, harga_per_malam, hari, pemandu_terpilih, harga_pemandu, harga_total, input_biaya
    ):
    print("="*35)
    print("          STRUK HOLIYAY             ")
    print("="*35)
...
'''Silahkan memilih rentang budget:
    ...
    # tampilkan tempat wisata dan hotel sesuai harga yang dipilih
...
for hotel in hotel_list:
    ...
    # input pilihan tempat wisata dan hotel
